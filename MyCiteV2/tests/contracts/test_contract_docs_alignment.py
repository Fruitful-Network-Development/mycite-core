...
class ContractDocsAlignmentTests(unittest.TestCase):
    ...
    def test_contract_docs_describe_behavioral_shell_model(self) -> None:
        ...
        self.assertNotIn("interface_panel_collapsed", shell_contract)
        self.assertNotIn("regions." + "inspector", shell_contract)
        self.assertNotIn("inspector" + "_collapsed", shell_contract)
    ...
    def test_surface_catalog_describes_one_aws_csm_tool(self) -> None:
        ...
        self.assertIn("default-visible", surface_catalog)
    ...
    def test_workbench_ui_contract_docs_describe_two_pane_sql_sheet(self) -> None:
        ...
        self.assertIn("authority lens", surface_catalog)
        ...
        self.assertIn("authority lens", docs_readme)
