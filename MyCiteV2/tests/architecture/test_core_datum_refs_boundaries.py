...
PACKAGE_DIR = PROJECT_ROOT / "packages" / "core" / "datum_refs"
...
class CoreDatumRefsBoundaryTests(unittest.TestCase):
    ...
    def test_source_contains_no_runtime_or_instance_path_leakage(self) -> None:
        violations: list[str] = []
