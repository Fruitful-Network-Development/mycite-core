...
PACKAGE_DIR = PROJECT_ROOT / "packages" / "modules" / "domains" / "publication"
...
class PublicationDomainBoundaryTests(unittest.TestCase):
    ...
    def test_source_contains_no_runtime_or_alias_progeny_leakage(self) -> None:
        violations: list[str] = []
