...
# Wave-1 scaffold: Resources root surface schema (site-core gallery listing).
RESOURCES_ROOT_SURFACE_SCHEMA = "mycite.v2.portal.resources.surface.v1"
UTILITIES_TOOL_EXPOSURE_SURFACE_SCHEMA = "mycite.v2.portal.utilities.tool_exposure.surface.v1"
# Phase 14b: four new surface schemas for the per-purpose Utilities split.
UTILITIES_EXTENSIONS_SURFACE_SCHEMA = "mycite.v2.portal.utilities.extensions.surface.v1"
UTILITIES_GRANTEE_PROFILE_SURFACE_SCHEMA = "mycite.v2.portal.utilities.grantee_profile.surface.v1"
...
def build_portal_runtime_entrypoint_catalog() -> tuple[PortalRuntimeEntrypointDescriptor, ...]:
    return (
        ...
        PortalRuntimeEntrypointDescriptor(
            ...
            route="/portal/api/v2/system/tools/workbench-ui",
            request_schema=WORKBENCH_UI_TOOL_REQUEST_SCHEMA,
            surface_schema=WORKBENCH_UI_TOOL_SURFACE_SCHEMA,
            read_write_posture="read-only",
...
def surface_schema_for_surface(surface_id: str) -> str:
    mapping = {
        ...
        RESOURCES_ROOT_SURFACE_ID: RESOURCES_ROOT_SURFACE_SCHEMA,
        UTILITIES_TOOL_EXPOSURE_SURFACE_ID: UTILITIES_TOOL_EXPOSURE_SURFACE_SCHEMA,
        UTILITIES_EXTENSIONS_SURFACE_ID: UTILITIES_EXTENSIONS_SURFACE_SCHEMA,
        UTILITIES_GRANTEE_PROFILE_SURFACE_ID: UTILITIES_GRANTEE_PROFILE_SURFACE_SCHEMA,
...
def route_for_surface(surface_id: str) -> str:
    mapping = {
        ...
        RESOURCES_ROOT_SURFACE_ID: RESOURCES_ROOT_ROUTE,
        UTILITIES_TOOL_EXPOSURE_SURFACE_ID: UTILITIES_TOOL_EXPOSURE_ROUTE,
        UTILITIES_EXTENSIONS_SURFACE_ID: UTILITIES_EXTENSIONS_ROUTE,
        UTILITIES_GRANTEE_PROFILE_SURFACE_ID: UTILITIES_GRANTEE_PROFILE_ROUTE,
