...
class NewsletterService:
    def __init__(
        self,
        state_port: NewsletterStatePort,
        cloud_port: NewsletterCloudPort,
        *,
        tenant_id: str,
    ) -> None:
    ...
    def resolve_domain_state(
        ...
        *,
        ...
        return {
            "schema": "mycite.v2.portal.system.tools.newsletter.domain_state.v2",
            "domain": token,
    ...
    def family_health(
        ...
        *,
        ...
        return {
            "schema": "mycite.v2.portal.system.tools.newsletter.family_health.v2",
