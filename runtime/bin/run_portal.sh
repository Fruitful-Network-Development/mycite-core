...
MYCITE_REPO_ROOT="${MYCITE_REPO_ROOT:-$(cd "${SCRIPT_DIR}/../.." && pwd)}"

PORTAL_WORKERS="${PORTAL_WORKERS:-2}"
PORTAL_THREADS="${PORTAL_THREADS:-4}"
PORTAL_TIMEOUT="${PORTAL_TIMEOUT:-60}"
MYCITE_PORTALS_ROOT="${MYCITE_PORTALS_ROOT:-${MYCITE_REPO_ROOT}/portals}"
MYCITE_PORTAL_RUNTIME_DIR="${MYCITE_PORTAL_RUNTIME_DIR:-${MYCITE_REPO_ROOT}/runtime}"
MYCITE_PORTAL_VENV="${MYCITE_PORTAL_VENV:-${MYCITE_REPO_ROOT}/.venv}"
