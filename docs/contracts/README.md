...
### Tool And Publication Contracts
...
Not every active peripheral surface has a top-level repo contract page yet.

Current deferred contract/documentation follow-ons:
...
- FND-EBI semantics are grounded in code-adjacent port/module docs plus runtime docs
- host capability bootstrap remains partially described in runtime code and portal authority usage
