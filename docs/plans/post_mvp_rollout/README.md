...
- Completed admin-first slices: `Admin Band 0`, `admin_band1.aws_read_only_surface`, `admin_band2.aws_narrow_write_surface`, `admin_band3.aws_csm_sandbox_surface`, `admin_band4.aws_csm_onboarding_surface`, `admin_band5.cts_gis_read_only_surface`, and `admin_band6.fnd_ebi_read_only_surface` (FND-first rollout).
...
- Current expansion posture: follow-on slices may resume from the reopened Band
  1 sequence documented in [current_planning_index.md](current_planning_index.md). `AWS-CSM` is the implemented service-tool family root, `CTS-GIS` is the implemented general-tool spatial family root, and `FND-EBI` is now the implemented hosted/site visibility family root.
...
1. Use [../v2.3-tool_surface_packet/fnd_ebi.md](../v2.3-tool_surface_packet/fnd_ebi.md) as current implementation truth for the live hosted/site visibility family root.
2. Use [../v2.3-tool_surface_packet/cts_gis.md](../v2.3-tool_surface_packet/cts_gis.md) as current spatial family truth.
