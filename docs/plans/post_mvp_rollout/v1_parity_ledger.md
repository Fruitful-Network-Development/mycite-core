...
| CTS-GIS, AGRO, and HOPS-specific mediation | `instances/_shared/portal/application/agro/*`, `instances/_shared/portal/application/time_address_schema.py`, `docs/plans/tool_dev.md` | deferred | not assigned | Requires later mediation and HOPS work. Not a post-MVP first-band target. |
