...
This plan set is complete for shell unification. It remains in `docs/plans/` as the closeout record for the canonical family-contract migration and fallback-key retirement.
