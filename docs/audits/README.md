...
- `cts_gis_mockup_prototype_gap_audit_2026-04-16.md` records a comprehensive diagnosis of why recent CTS-GIS commits remain short of the prototype interaction model (ordered-hierarchy hover redistribution, recursive subordinate rails), despite contract-level dual-section alignment.
