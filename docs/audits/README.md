...
- `documentation_agent_yaml_optimization_plan_2026-04-16.md` was removed after standards/backlog/report artifacts became the retained canonical execution set (`docs/standards/*`, `docs/plans/documentation_ia_remediation_backlog.md`, and `docs/audits/reports/documentation_ia_audit_report_2026-04-20.md`).
