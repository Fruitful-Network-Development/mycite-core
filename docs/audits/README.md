...
This directory stores evidence, notes, and historical inspection output.

- It may explain why a v2 document exists.
- It must not become the source of truth for v2 structure.
- If an audit conflicts with the authority stack, the audit loses.
- Use [../governance/README.md](../governance/README.md) for lifecycle and review rules around evidence documents.
- Use [../governance/reading_paths.md](../governance/reading_paths.md) when you need a task-based entrypoint instead of an audit-first reading order.
